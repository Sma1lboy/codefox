...
export const prompts = {
  'codefox-PRD': {
    MainPrompt: `You are an expert Product Manager. Your job is to analyze and expand upon the details provided, generating a Full Product Requirement Document (PRD) based on the following inputs:  
      - Project name: {}
      - Description: {}
      - Platform: {}
