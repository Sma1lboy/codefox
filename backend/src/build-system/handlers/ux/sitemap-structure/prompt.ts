export const prompts = {
  generateUXSiteMapStructurePrompt: (
    ...
    return `You are an expert frontend developer and UX designer. Your job is to analyze and expand upon the details provided, generating a Full UX Sitemap Structure Document based on the following inputs:
        ...
        Output Requirements:
          ...
          IMPORTANT: you should typically NOT create <global_view> sections unless explicitly required in the UX Sitemap Document. Instead, include all UI components directly within the <page_view> block.
